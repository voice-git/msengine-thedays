 ...
 */
$calColorBgDark      = '#000';	// dark background color
$calColorTextOnDark  = '#fff';	// text appearing on top of dark bg color
$calColorBgLight     = '#ccc';	// light background color
$calColorTextOnLight = '#000';	// text appearing on top of light bg color
$calColorBgToday     = '#eee';	// background color for "today" box
...
.mv-event-container{pointer-events: none!important;}
